...
import com.example.gd3_c_0989.entity.Mahasiswa
...
class RVMahasiswaAdapter (private val data:Array<Mahasiswa>) : RecyclerView.Adapter<RVMahasiswaAdapter.viewHolder>(){
    ...
    class viewHolder(itemView : View):RecyclerView.ViewHolder(itemView){
        val tvNama : TextView = itemView.findViewById(R.id.tv_nama_dosen)
        val tvDetails : TextView = itemView.findViewById(R.id.tv_details_dosen)
    }
}